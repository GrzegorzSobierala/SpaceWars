    ...
    public class BlurRendererFeature : ScriptableRendererFeature
    {
        class BlurLayerRenderPass : ScriptableRenderPass
        {
            ...
            public BlurLayerRenderPass(string profilerTag, int layerMask, BlurRendererFeature feature)
            {
                ...
                if (_feature._blurRenderTextureaaa)
                {
                    this._rtHandle = RTHandles.Alloc(feature._blurRenderTextureaaa);
                }
                else
                {
            ...
            public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
            {
                ...
                if (!_rtHandle.rt || _rtHandle != _feature._blurRenderTextureaaa)
                {
                    if (_feature._blurRenderTextureaaa)
                    {
                        _rtHandle = RTHandles.Alloc(_feature._blurRenderTextureaaa);
                    }
        ...
        [SerializeField] private RenderTexture _blurRenderTextureaaa;
