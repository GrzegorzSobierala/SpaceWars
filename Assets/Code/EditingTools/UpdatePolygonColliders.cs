...
public class UpdatePolygonColliders : MonoBehaviour
{
    [SerializeField] private MeshFilter meshFilter;

    [ContextMenu(nameof(UpdateCollider))]
    void UpdateCollider()
    {
        if (meshFilter == null)
        {
            Debug.LogWarning("MeshFilter reference is null!");
            return;
        }
        ...
        {
            Debug.LogWarning("No PolygonCollider2D component found on GameObject!");
            return;
        }
        ...
        //int[] targetTriangles = EdgeHelpers.RotateAndScaleTriangles(meshFilter,
        //    meshFilter.transform.localRotation.eulerAngles, meshFilter.transform.localScale);
        ...
        Debug.Log(gameObject.name + " PolygonCollider2D updated and made convex.");
    }

    Vector2[] MakeConvex(Vector2[] points)
    {
    ...
    bool IsClockwiseTurn(Vector2 a, Vector2 b, Vector2 c)
    {
